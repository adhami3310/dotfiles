...
const ModifiedBarLevel = Me.imports.modifiedBarLevel;

var SLIDER_SCROLL_STEP = 0.02; /* Slider scrolling step in % */

var ModifiedSlider = GObject.registerClass({
    Signals: {
        'drag-begin': {},
        'drag-end': {},
    },
}, class ModifiedSlider extends ModifiedBarLevel.ModifiedBarLevel {
    _init(value, iconFunction) {
        super._init({
            value,
            style_class: 'slider android-slider',
            can_focus: true,
            reactive: true,
        ...
        if (iconFunction) this.iconFunction = iconFunction;
        this._releaseId = 0;
    ...
    vfunc_repaint() {
        ...
        const ceiledHandleRadius = Math.ceil(handleRadius);
