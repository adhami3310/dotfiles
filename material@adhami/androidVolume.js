...
function iconFunction(cr, handleX, handleY, color) {
    ...
    cr.lineTo(handleX+3, handleY-10);
    cr.lineTo(handleX+6, handleY-10);
    cr.lineTo(handleX+6, handleY-13);
    cr.lineTo(handleX+1.5, handleY-13);
    cr.lineTo(handleX+1.5, handleY);
    cr.fill();
}
...
function micFunction(cr, handleX, handleY, color) {
    ...
    cr.stroke();
    cr.arc(handleX, handleY-8, 6, 0, -Math.PI);
    cr.stroke();
    cr.arc(handleX, handleY-8, 4, 0, -Math.PI);
    cr.lineTo(handleX-4, handleY-11);
    cr.arc(handleX, handleY-12, 4, Math.PI, 0);
    cr.lineTo(handleX+4, handleY-8);
    cr.fill();
}
...
}, class StreamSlider extends iconAndroidQuickSlider.IconAndroidQuickSlider {
    _init(control, iconFunc) {
        super._init(iconFunc);
...
class OutputStreamSlider extends StreamSlider {
    _init(control) {
        super._init(control, iconFunction);
...
class InputStreamSlider extends StreamSlider {
    _init(control) {
        super._init(control, micFunction);
